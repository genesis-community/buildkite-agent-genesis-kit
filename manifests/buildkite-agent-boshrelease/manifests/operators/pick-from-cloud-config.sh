...
# The base manifests/buildkite-agent.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/buildkite-agent.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
